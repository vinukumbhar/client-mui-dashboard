  ...
  return {
    palette: {
      ...
      menu: {
        ...
        main: menu[500],
        dark: menu[700],
        contrastText: mode === 'dark' ? gray[50] : gray[900],
      },
      grey: {
        ...gray,
      },
      ...
      text: {
        primary: gray[800],
        secondary: gray[600],
        menu: mode === 'dark' ? menu[400] : menu[600],
        warning: orange[400],
        ...(mode === 'dark' && {
          primary: 'hsl(0, 0%, 100%)',
          secondary: gray[400],
    ...
    components: {
      MuiListItemButton: {
        styleOverrides: {
          root: {
            '&.Mui-selected': {
              backgroundColor: mode === 'dark' ? alpha(menu[700], 0.6) : alpha(menu[300], 0.3),
              borderLeft: `3px solid ${menu[500]}`,
            },
          },
        },
      },
